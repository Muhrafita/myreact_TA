          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col h-full">
            ...
            <div className="space-y-5 relative pl-5 border-l-4 border-blue-600 flex-grow">
              ...
              <div className="text-slate-500 text-base leading-relaxed font-light text-justify space-y-4">
                <p>
                  Fokus riset saya bertitik tumpu pada implementasi sistem instrumentasi cerdas untuk menjawab tantangan standarisasi kualitas pada rantai pasok pangan. Dengan mengintegrasikan prinsip-prinsip fisika sensor dan arsitektur <span className="font-semibold italic italic italic">Internet of Things</span>, saya berupaya menghadirkan solusi pengujian yang bersifat objektif, non-invasif, dan akurat secara real-time.
                </p>
                <p>
                  Melalui pendekatan metodologis yang komprehensif, riset ini bertujuan untuk meminimalisir subjektivitas manusia dalam penilaian kualitas komoditas protein, guna mendukung terciptanya ekosistem ketahanan pangan nasional yang berbasis data.
                </p>
              </div>
